                ...
                <form class="x_panel">
                    ...
                    <div class="col-md-12 ">
                        <div class="x_panel">
                            ...
                            <div class="clearfix"></div>
                            <div class="x_content">
                                <form action="{{route('user_image_store' , ['apartment_id'=> $data->id ])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <tbody>
                                                    @foreach($images as $rs)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                    <a href="{{route('user_image_delete',['id'=> $rs->id, 'apartment_id'=> $data->id])}}" onclick="return confirm('Record will be Delete! Are you sure?')">
